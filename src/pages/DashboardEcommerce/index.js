                  ...
                  <Col xs={12}>
                    <div className="d-flex align-items-lg-center flex-lg-row flex-column">
                      <div className="flex-grow-1">
                        <h4 className="fs-16 mb-1">DAY TRANSACTIONS REPORT</h4>
                      </div>
                    </div>
                  </Col>
                </Row>
                      ...
                      <div className="d-flex">
                        <Nav pills className="animation-nav profile-nav gap-2 gap-lg-3 flex-grow-1"
                          ...
                          <NavItem>
                            ...
                            >
                              <i className="ri-price-tag-line d-inline-block d-md-none"></i> <span
                                className="d-none d-md-inline-block"><div style={{ color: "white" }}>SEARCH BY DATE</div></span>
                            </NavLink>
                          </NavItem>
                        </Nav>
                      </div>
              ...
              <Col xxl={3} md={6}>
                <div>
                  ...
                  <Flatpickr
                    ...
                    onChange={([date]) => {
                      setSelectedRange(moment(date, 'YYYY-MM-DD').add(5, 'days'));
                    }}
                  />
                </div>
              </Col>
              <Col xxl={3} md={6}>
                <div>
                  ...
                  <Flatpickr
                    ...
                    onChange={([date]) => {
                      setSelectedRange2(moment(date, 'YYYY-MM-DD').add(5, 'days'));
                    }}
                  />
                </div>
              </Col>
