            ...
            <Col xl={4}>
                <Card className="card-height-100">
                    <CardHeader className="align-items-center d-flex">
                        <h4 className="card-title mb-0 flex-grow-1">Assets by Locations</h4>
                    ...
                    <CardBody>
                        ...
                        <div className="px-2 py-2 mt-1">
                            <p className="mb-1">Harare <span className="float-end">75%</span></p>
                            ...
                            <p className="mt-3 mb-1">Bulawayo <span className="float-end">47%</span></p>
                            <div className="progress mt-2" style={{ height: "6px" }}>
                                <div className="progress-bar progress-bar-striped bg-primary" role="progressbar"
                            ...
                            <p className="mt-3 mb-1">Chegutu <span className="float-end">82%</span></p>
                            <div className="progress mt-2" style={{ height: "6px" }}>
                                <div className="progress-bar progress-bar-striped bg-primary" role="progressbar"
